...
While the former one demonstrates all features in one real world example, the latter one separetes the examples by feature. The Real World example shows that all features can be used altogether.
